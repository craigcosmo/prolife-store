		...
		<div style={css.footer}>
			<div style={css.wrapper}>
				<div style={{ ...css.dec1, ...css.share }}>
					...
					<div style={css.par}>
						Cty prolife nhà phân phối sản phẩm của thương hiệu dyson tại Việt
						Nam{' '}
					</div>
					<div style={css.par}>
				...
				<div style={{ ...css.dec2, ...css.share }}>
					...
					<div>
						...
						<a
							style={css.link}
							href={'https://www.youtube.com/user/dysonteam'}
							target="_blank">
						...
						<a
							style={css.link}
							href={
								'mailto:prolife.customer@gmail.com?subject=myhutbuidyson&body=hey, website ban san may hut bui dyson'
							}>
				...
				<div style={{ ...css.dec3, ...css.share }}>
					...
					<div style={css.par}>
						<a
							href={
								'mailto:prolife.customer@gmail.com?subject=xin chao toi can tim hieu san pham&body=chao prolife, toi can biet ve san pham...'
							}>
							prolife.customer@gmail.com
						</a>
					</div>
				</div>
			</div>
